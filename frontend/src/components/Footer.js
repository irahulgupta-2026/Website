  ...
  return (
    <footer className="border-t border-white/10 mt-24 bg-black">
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><Phone className="w-4 h-4 mt-0.5" /> +91 90 46 037840</li>
            <li className="flex items-start gap-2"><Mail className="w-4 h-4 mt-0.5" /> ajitarya181118@gmail.com</li>
            <li className="flex items-start gap-2"><MapPin className="w-4 h-4 mt-0.5" /> Asansol, West Bengal</li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10 py-6 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-2 text-xs text-muted-foreground">
        <span>© 2026 Arya Travels. All rights reserved.</span>
